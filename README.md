...
✨ **جديد**: الآن مع دعم كامل للغة العربية | تطبيق سطح مكتب (Electron) | PWA للويب

[المعاينة المباشرة](https://aiforgestudio.net) | [تحميل التطبيق](https://aiforgestudio.net/download.html) | [دليل البناء](BUILD-GUIDE.md) | [دليل C++/Qt](CPP-Qt-Integration-Guide.md)
...
### 🌐 دعم متعدد المنصات
- **🌍 دعم اللغة العربية والإنجليزية** - تبديل فوري بين اللغات مع دعم RTL/LTR
- **🖥️ تطبيق سطح المكتب** - تطبيق Electron لـ Windows، macOS، Linux
- **📱 تطبيق ويب تقدمي (PWA)** - تثبيت على الجهاز والعمل دون اتصال
- **☁️ نسخة إلكترونية** - استخدم مباشرة من المتصفح
...
- **Improved Scrolling** - شريط تمرير محسّن وأداء أفضل
